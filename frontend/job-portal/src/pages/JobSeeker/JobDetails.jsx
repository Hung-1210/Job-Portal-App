        ...
        {jobDetails && (
          <div className="bg-white p-6 rounded-lg">
            ...
            <div className="relative px-0 pb-8 border-b border-gray-100">
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  {jobDetails?.company?.companyLogo ? (
                    <img
                      ...
                      alt="Company Logo"
                      className="h-20 w-20 object-cover rounded-2xl border-4 border-white shadow-lg"
                    />
                  ) : (
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="rounded-full border border-blue-200">
                    {jobDetails.category}
                  </span>
                  <span className="px-4 py-2 text-sm bg-purple-50 text-purple-700 font-semibold rounded-full border border-purple-200">
                    {jobDetails.type}
                  </span>
                  <div className="flex items-center spacex-x-1 px-4 bg-gray-50 text-sm text-gray-700 font-semibold rounded-full border border-gray-200">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-100 rounded-full p-6">
                <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
