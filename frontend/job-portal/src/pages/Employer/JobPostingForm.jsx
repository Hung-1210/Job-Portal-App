...
const JobPostingForm = () => {
    ...
    try {
      const response = jobId
        ...
        if(response.status === 200 || response.status === 201) {
          toast.success(
            jobId ? "Job update Successfully!" : "Job Posted Successfully!"
          );
          setFormData({
            jobTitle: "",
            location: "",
  ...
  return (
    <DashboardLayout activeMenu = "post-job">
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-pink-50/20 py-8 px-4 sm:px-6 lg:px-8">
