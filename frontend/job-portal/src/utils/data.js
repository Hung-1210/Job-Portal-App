...
export const jobSeekerFeatures = [
    {
        ...
        description: 
        "AI-powered algorithms matches you with relevant ooportunities based on your skills and preferences.",
    },
    {
        icon: FileText,
        title: 'Resume Builder',
        description: 
        "Create professional resumes with our intuitive builder and templates designed.",
    },
    {
        icon: MessageSquare,
...
export const employerFeatures = [
    ...
    },
    {
        ...
        description: 
        "All candidate undergo background verification to ensure you're hiring trustworthy professionals.",
    },
    {
        icon: Clock,
        title: 'Quick Hiring',
